...
# Unified file processing function (to match second code style)
def process_uploaded_file(file, month_input):
    df = pd.read_csv(file)
...
if df_all.empty:
    ...
    if not route_col:
        ...
        fig1 = px.line(miles_trend, x="Entered_Month", y="Monthly Miles", color=route_col,
